...
namespace UKLib.MathEx
{
    public class MatrixC
    {
        ...
        public MatrixC(string matrix_string)
        {
            // remove spaces
        ...
        /// <returns></returns>
        public static MatrixC E(int n, int j)
        {
            MatrixC e = Zeros(n, 1);
            e[j] = Complex.One;
        ...
        /// <returns></returns>
        public static MatrixC ChessboardMatrix(int m, int n, bool even)
        {
            MatrixC M = new MatrixC(m, n);
        ...
        /// <param name="even">Indicates, if matrix entry (1,1) equals zero.</param>
        /// <returns></returns>
        public static MatrixC ChessboardMatrix(int n, bool even)
        {
            MatrixC M = new MatrixC(n);
        ...
        public static MatrixC Zeros(int m, int n)
        {
            return new MatrixC(m, n);
        }
        ...
        public static MatrixC Zeros(int n)
        {
            return new MatrixC(n);
        }
        ...
        public static MatrixC Ones(int m, int n)
        {
            MatrixC M = new MatrixC(m, n);
        ...
        public static MatrixC Ones(int n)
        {
            MatrixC M = new MatrixC(n);
        ...
        /// <param name="n">Number of rows and columns, resp.</param>
        /// <returns></returns>
        public static MatrixC Eye(int n)
        {
            return Identity(n);
        }
        ...
        public static MatrixC VerticalConcat(MatrixC A, MatrixC B)
        {

            MatrixC C = A.Column(1);
        ...
        public static MatrixC VerticalConcat(MatrixC[] A)
        {
            if (A == null)
            ...
            {
                MatrixC C = VerticalConcat(A[0], A[1]);
        ...
        public static MatrixC HorizontalConcat(MatrixC A, MatrixC B)
        {
            MatrixC C = A.Row(1);
        ...
        public static MatrixC HorizontalConcat(MatrixC[] A)
        {
            if (A == null)
                throw new ArgumentNullException();
            else if (A.Length == 1)
            ...
            {
                MatrixC C = HorizontalConcat(A[0], A[1]);
        ...
        /// <returns></returns>
        public static MatrixC Diag(MatrixC diag_vector)
        {
        ...
        /// <param name="diag_vector">column vector containing the diag elements</param>
        /// <returns></returns>
        public static MatrixC Diag(MatrixC diag_vector, int offset)
        {
            int dim = diag_vector.VectorLength();
            ...
            //if (System.Math.Abs(offset) >= dim)
            //    throw new ArgumentException("Absolute value of offset must be less than length of diag_vector.");

            MatrixC M = new MatrixC(dim + System.Math.Abs(offset), dim + System.Math.Abs(offset));
            dim = M.RowCount;
        ...
        public static MatrixC TriDiag(Complex l, Complex d, Complex u, int n)
        {
            if (n <= 1)
        ...
        /// <returns></returns>
        public static MatrixC TriDiag(MatrixC l, MatrixC d, MatrixC u)
        {
        ...
        public static Complex Dot(MatrixC v, MatrixC w)
        {
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static MatrixC RandomGraph(int n)
        {
            MatrixC buf = Random(n, n);
        ...
        /// <returns></returns>
        public static MatrixC RandomGraph(int n, double p)
        {
            MatrixC buf = new MatrixC(n);
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static MatrixC Random(int m, int n)
        {
            MatrixC M = new MatrixC(m, n);
            Random r = new Random();
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static MatrixC Random(int n)
        {
            MatrixC M = new MatrixC(n);
            Random r = new Random();
        ...
        /// <returns></returns>
        public static MatrixC Random(int n, int lo, int hi)
        {
            MatrixC M = new MatrixC(n);
            Random r = new Random();
        ...
        /// <returns></returns>
        public static MatrixC RandomZeroOne(int m, int n, double p)
        {
            MatrixC M = new MatrixC(m, n);
            Random r = new Random();
        ...
        /// <param name="p">Probability fro an entry to be one, expecting a value in [0,1].</param>
        /// <returns></returns>
        public static MatrixC RandomZeroOne(int n, double p)
        {
            MatrixC M = new MatrixC(n, n);
            Random r = new Random();
        ...
        /// <param name="n">Number of columns.</param>
        /// <returns></returns>
        public static MatrixC Random(int m, int n, int lo, int hi)
        {
            MatrixC M = new MatrixC(m, n);
            Random r = new Random();
        ...
        public static MatrixC Vandermonde(Complex[] x)
        {
        ...
        /// u to v.</returns>
        public static MatrixC[] Floyd(MatrixC adjacence_matrix)
        {
            ...
            MatrixC D = adjacence_matrix.Clone(); // distance matrix
            MatrixC P = new MatrixC(n);
        ...
        /// <returns></returns>
        public static ArrayList FloydPath(MatrixC P, int i, int j)
        {
            if (!P.IsSquare())
        ...
        public static MatrixC DFS(MatrixC adjacence_matrix, int root)
        {
            if (!adjacence_matrix.IsSquare())
            ...
            MatrixC spanTree = new MatrixC(n);
        ...
        /// <param name="root">The vertex to begin the search.</param>
        /// <returns>Adjacence matrix of the computed spanning tree.</returns>
        public static MatrixC BFS(MatrixC adjacence_matrix, int root)
        {
            if (!adjacence_matrix.IsSquare())
                throw new ArgumentException("Adjacence matrices are expected to be square.");
            else if (!adjacence_matrix.IsReal())
        ...
        /// <returns></returns>
        public static MatrixC ZeroOneRandom(int m, int n, double p)
        {
            Random r = new Random();

            MatrixC buf = Zeros(m, n);
        ...
        /// <param name="p">Probability of each entry being 1.</param>
        /// <returns></returns>
        public static MatrixC ZeroOneRandom(int n, double p)
        {
            Random r = new Random();
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        private static MatrixC[] HouseholderVector(MatrixC x)
        {
            ...
            return new MatrixC[] { v, new MatrixC(beta) };
        ...
        /// <returns></returns>
        public static MatrixC BlockMatrix(MatrixC A, MatrixC B, MatrixC C, MatrixC D)
        {
            ...
            MatrixC R = new MatrixC(A.RowCount + C.RowCount, A.ColumnCount + B.ColumnCount);
        ...
        public static MatrixC Solve(MatrixC A, MatrixC b)
        {
            MatrixC A2 = A.Clone();
            MatrixC b2 = b.Clone();
        ...
        public MatrixC Re()
        {
            MatrixC M = new MatrixC(rowCount, columnCount);
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixC[] HessenbergHouseholder()
        {
            ...
            int n = rowCount;
            MatrixC Q = Identity(n);
            MatrixC H = this.Clone();
            MatrixC I, N, R, P;
            MatrixC[] vbeta = new MatrixC[2];
            int m;
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixC ExtractLowerTrapeze()
        {
            MatrixC buf = new MatrixC(rowCount, columnCount);
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixC ExtractUpperTrapeze()
        {
            MatrixC buf = new MatrixC(rowCount, columnCount);
        ...
        public MatrixC[] ColumnVectorize()
        {
            MatrixC[] buf = new MatrixC[columnCount];
        ...
        public MatrixC[] RowVectorize()
        {
            MatrixC[] buf = new MatrixC[rowCount];
        ...
        public MatrixC ExtractRow(int i)
        {
            MatrixC buf = this.Row(i);
            this.DeleteRow(i);
        ...
        /// <returns>Row vector.</returns>
        public MatrixC ExtractColumn(int j)
        {
            if (j <= 0 || j > columnCount)
                throw new ArgumentException("Index must be positive and <= number of cols.");

            MatrixC buf = this.Column(j);
            this.DeleteColumn(j);
        ...
        public void InsertRow(MatrixC row, int i)
        {
        ...
        public void Insert(int i, int j, MatrixC M)
        {            
        ...
        public void InsertColumn(MatrixC col, int j)
        {
        ...
        public MatrixC Inverse()
        {
            ...
            if (n == 1) return new MatrixC(1 / det);
        ...
        /// </summary>
        /// <returns>Inverse of matrix.</returns>
        public MatrixC InverseLeverrier()
        {
            if (!this.IsSquare())
                throw new InvalidOperationException("Cannot invert non-square matrix.");
            ...
            int n = this.rowCount;
            MatrixC Id = Identity(n);
            MatrixC B = Id;
            Complex alpha;

            for (int k = 1; k < n; k++)
            {                
                MatrixC buf = (this * B); // DEBUG                
                Complex buf2 = buf.Trace(); // DEBUG
                alpha = ((double)1 / k) * buf.Trace();
                B = alpha * Id - buf;
            }

            MatrixC buf3 = (this * B); // DEBUG                
        ...
        /// <returns></returns>
        public MatrixC Minor(int i, int j)
        {
        ...
        public MatrixC Column(int j)
        {
            MatrixC buf = new MatrixC(this.rowCount, 1);
        ...
        public MatrixC Row(int i)
        {
            ...
            MatrixC buf = new MatrixC(columnCount, 1);
        ...
        {
            MatrixC M = new MatrixC(columnCount, rowCount);
        ...
        public MatrixC LUSafe()
        {
            ...
            MatrixC P = Identity(n); // permutation matrix
            int m;
        ...
        public void ForwardInsertion(MatrixC b)
        {
        ...
        /// </summary>
        /// <param name="b">Vector of height n, if matrix is n by n.</param>
        public void BackwardInsertion(MatrixC b)
        {
        ...
        public MatrixC[] QRGramSchmidt()
        {
            ...
            MatrixC Q = new MatrixC(m, n);
            MatrixC R = new MatrixC(n, n);
        ...
        /// <returns></returns>
        public MatrixC Eigenvector(Complex eigenvalue)
        {
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        public MatrixC SolveCG(MatrixC b)
        {
            throw new NotImplementedException("Still buggy!");
            ...
            MatrixC x = Ones(n, 1); // x will contain the solution
            MatrixC r = b - this * x; // residual approaches zero as x converges to the solution
            MatrixC d = r; // dir = direction of descence
        ...
        /// <returns></returns>
        public MatrixC QRIterationBasic(int max_iterations)
        {
            if (!this.IsReal())
                throw new InvalidOperationException("Basic QR iteration is possible only for real matrices.");

            MatrixC T = this.Clone();
            MatrixC[] QR = new MatrixC[2];
        ...
        /// <param name="max_iterations"></param>
        /// <returns></returns>
        public MatrixC QRIterationHessenberg(int max_iterations)
        {
            ...
            MatrixC[] TQ = this.HessenbergHouseholder();
            MatrixC T = TQ[0];

            for (int j = 1; j <= max_iterations; j++)
            {
                MatrixC[] QRcs = T.QRGivens();
                T = QRcs[1];
        ...
        public MatrixC[] QRGivens()
        {
            ...
            MatrixC c = Zeros(n - 1, 1);
            MatrixC s = Zeros(n - 1, 1);
            Complex[] cs;
            ...
            return new MatrixC[] { GivProd(c, s, n), H, c, s };*/
        }
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        private MatrixC GivProd(MatrixC c, MatrixC s, int n)
        {
            int n1 = n - 1;
            int n2 = n - 2;
            ...
            for (int k = n2; k >= 1; k--)
            {
                ...
                Q[k, k] = c[k];
                Q[k1, k] = -s[k];
                MatrixC q = Q.Extract(k1, k1, k1, n);
                Q.Insert(k, k1, s[k] * q);
        ...
        public DefinitenessType Definiteness()
        {
            ...
            MatrixC[] y = new MatrixC[n + 1];
            for (int i = 0; i <= n; i++)
                y[i] = MatrixC.Zeros(n, 1);

            y[1] = this.Column(1);

            MatrixC xk; // to buffer this.Column(k)
            MatrixC buf;
        ...
        public static bool operator ==(MatrixC A, MatrixC B)
        {
        ...
        public static MatrixC operator *(MatrixC A, MatrixC B)
        {
            ...
            MatrixC C = new MatrixC(A.RowCount, B.ColumnCount);
        ...
        public static MatrixC operator *(MatrixC A, Complex x)
        {
           
            MatrixC B = new MatrixC(A.rowCount, A.columnCount);
        ...
        public static MatrixC operator *(Complex x, MatrixC A)
        {
        ...
        public static MatrixC operator *(MatrixC A, double x)
        {
            return (new Complex(x)) * A;
        }

        public static MatrixC operator *(double x, MatrixC A)
        {
            return (new Complex(x)) * A;
        }        
        ...
        public static MatrixC operator ^(MatrixC A, int k)
        {
            if (k < 0)
                if (A.IsSquare())
                ...
                if (A.IsSquare())
                    return MatrixC.Identity(A.RowCount);
                else throw new InvalidOperationException("Cannot take non-square matrix to the power of zero.");
            else if (k == 1)
                if (A.IsSquare())
                    return A;
