...
using System.Text;
using UKLib.Fireball.Syntax.SyntaxDocumentParsers;
...
namespace UKLib.Fireball.Syntax
{
    ...
    public class SyntaxDocument : Component, IEnumerable
    {
        ...
        public void ParseSome(int RowCount)
        {
            ...
            {
//				UKLib.Debug.DebugClass.SendDebugLine(this,UKLib.Debug.DebugLevel.Red, (this.KeywordQueue.Count.ToString ());
                int i = 0;
        ...
        public void DeleteRange(TextRange Range, bool StoreUndo)
        {
            ...
            if (r.FirstRow == r.LastRow)
            {
                ...
                int max = System.Math.Min(r.FirstColumn, xtr.Text.Length);
            ...
            else
            {
                ...
                int Max = System.Math.Min(xtr2.Text.Length, r.LastColumn);
        ...
        public string GetRange(TextRange Range)
        {
            ...
            if (Range.FirstRow != Range.LastRow)
            {
                ...
                int mx = System.Math.Min(r1.Text.Length, Range.FirstColumn);
                ...
                int Max = System.Math.Min(r2.Text.Length, Range.LastColumn);
            ...
            else
            {
                ...
                int Max = System.Math.Min(r.Text.Length, Range.LastColumn);
...
//			}
        ...
        public int PointToIntPos(TextPoint pos)
        {
            ...
            return p + System.Math.Min(pos.X, this[pos.Y].Text.Length);
        }
