	...
	public class LanguageList
	{
		...
		public LanguageList()
		{
			...
			foreach (string file in files)
			{
				...
				//{
				//	UKLib.Debug.DebugClass.SendDebugLine(this,UKLib.Debug.DebugLevel.Red, (x.Message);
				//}
			}
		...
		public Language GetLanguageFromFile(string path)
		{
			...
			foreach (UKLib.Fireball.Syntax.Language lang in mLanguages)
			{
				foreach (UKLib.Fireball.Syntax.FileType ft in lang.FileTypes)
				{
