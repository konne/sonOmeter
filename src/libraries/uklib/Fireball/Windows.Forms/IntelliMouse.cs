...
//			this.Visible =false;
		...
		protected override void Dispose(bool disposing)
		{
			...
			try
			{
				UKLib.Debug.DebugClass.SendDebugLine(this,UKLib.Debug.DebugLevel.Red,"disposing intellimouse");
			}
			catch
			{
			}
		...
		~IntelliMouseControl()
		{
			...
			try
			{
				UKLib.Debug.DebugClass.SendDebugLine(this,UKLib.Debug.DebugLevel.Red,"finalizing intellimouse");
			}
			catch
			{
			}
		...
		protected void InitializeComponent()
		{
            ...
            this.regionHandler1 = new UKLib.Fireball.Windows.Forms.RegionHandler(this.components);
			// 
			// tmrFeedback
			// 
		...
		protected void SetCursor(int x, int y)
		{
			...
			if (dY > 16)
			{
                this.Cursor = new Cursor(assembly.GetManifestResourceStream("Windows.Forms.MoveDown.cur"));
				CurrentDelta.Y -= 16;

			}
			else if (dY < -16)
			{
                this.Cursor = new Cursor(assembly.GetManifestResourceStream("Windows.Forms.MoveUp.cur"));
				CurrentDelta.Y += 16;

			}
			else
			{
				this.Cursor = new Cursor(assembly.GetManifestResourceStream("Windows.Forms.MoveUpDown.cur"));
