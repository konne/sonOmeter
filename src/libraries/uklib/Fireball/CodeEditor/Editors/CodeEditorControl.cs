...
using UKLib.Fireball.Windows.Forms.CodeEditor;
	...
	public class CodeEditorControl : Widget
	{
     ...
     //   [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        public void Save(string filename)
        {
            ...
            this.OnFileSaved(EventArgs.Empty);
        }
...
//			this.splitView1.Visible = true;
		...
		protected override void Dispose(bool disposing)
		{
			...
			try
			{
				UKLib.Debug.DebugClass.SendDebugLine(this,UKLib.Debug.DebugLevel.Red,"disposing syntaxbox");
			}
			catch
			{
			}
		...
		~CodeEditorControl()
		{
			...
			try
			{
				UKLib.Debug.DebugClass.SendDebugLine(this,UKLib.Debug.DebugLevel.Red,"finalizing syntaxbox");
			}
			catch
			{
			}
